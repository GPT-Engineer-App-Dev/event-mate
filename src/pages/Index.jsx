      ...
      <VStack spacing={8} width="100%">
        ...
        <Box width="100%" mt={10}>
          ...
          <VStack spacing={4} align="stretch">
            <Box as={Link} to="/event/1" p={5} shadow="md" borderWidth="1px">
              <Heading fontSize="xl">Event 1</Heading>
              <Text mt={4}>Details about Event 1</Text>
            </Box>
            <Box as={Link} to="/event/2" p={5} shadow="md" borderWidth="1px">
              <Heading fontSize="xl">Event 2</Heading>
              <Text mt={4}>Details about Event 2</Text>
            </Box>
            <Box as={Link} to="/event/3" p={5} shadow="md" borderWidth="1px">
